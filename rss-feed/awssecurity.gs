...
var AWS_SECURITY_RSS_FEED_URL = "https://aws.amazon.com/blogs/security/feed/";
...
function AwsSecurityFetchNews() {
  ...
  Logger.log("Fetching '" + AWS_SECURITY_RSS_FEED_URL + "'...");
  
  var xml = UrlFetchApp.fetch(AWS_SECURITY_RSS_FEED_URL).getContentText();
