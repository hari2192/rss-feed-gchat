...
var ISTIO_RSS_FEED_URL = "https://istio.io/latest/news/feed.xml";
...
function IstiofetchNews() {
  ...
  Logger.log("Fetching '" + ISTIO_RSS_FEED_URL + "'...");
  
  var xml = UrlFetchApp.fetch(ISTIO_RSS_FEED_URL).getContentText();
