...
var AWS_ARCH_RSS_FEED_URL = "https://aws.amazon.com/blogs/architecture/feed/";
...
function AwsArchFetchNews() {
  ...
  Logger.log("Fetching '" + AWS_ARCH_RSS_FEED_URL + "'...");
  
  var xml = UrlFetchApp.fetch(AWS_ARCH_RSS_FEED_URL).getContentText();
