...
var AWS_DEVOPS_RSS_FEED_URL = "https://aws.amazon.com/blogs/devops/feed/";
...
function AwsDevopsfetchNews() {
  ...
  Logger.log("Fetching '" + AWS_DEVOPS_RSS_FEED_URL + "'...");
  
  var xml = UrlFetchApp.fetch(AWS_DEVOPS_RSS_FEED_URL).getContentText();
